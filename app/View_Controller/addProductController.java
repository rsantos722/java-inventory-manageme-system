 ...
 * For WGU C482 <br>
 *
 * Controller for Add Product screen <br>
 */
public class addProductController {
    ...
    @FXML // fx:id="partSearchBox"
    private TextField partSearchBox; // Value injected by FXMLLoader
    ...
    void addButtonAction(ActionEvent event) {
        ...
        //Add Product to Part
        product.addAssociatedPart(allParts.get(selectedPartIndex));
        //Update Table
        assocPartDataTable.setItems(product.getAllAssociatedParts());
    }
    ...
    void cancelButtonAction(ActionEvent event) {
        ...
        alert.setContentText("Are you sure exit without saving the Product?");
     ...
     */
    @FXML
    void partSearchBoxAction(KeyEvent event) {
        //Get text
     ...
     * Then, create new instance of Product, set values, then call addProduct <br>
     */
    @FXML
    void saveButtonAction(ActionEvent event) {
        ...
        product.setName(nameTextBox.getText());
     ...
     * Populates part table, and makes sure everything was loaded <br>
     */
    @FXML // This method is called by the FXMLLoader when initialization is complete
    void initialize() {
        assert partSearchBox != null : "fx:id=\"partSearchBox\" was not injected: check your FXML file 'addProduct.fxml'.";
